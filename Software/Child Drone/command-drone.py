...
def get_angles(cam, pid_x, pid_y, pid_z, pid_r):
    cam.update()
    x = pid_x.get_pid(cam.x, pid_x.get_dt(1))
    y = pid_y.get_pid(cam.y, pid_y.get_dt(1))
...
GAIN_D = 0.03
I_MAX = 100
pid_x = (GAIN_P, GAIN_I, GAIN_D, I_MAX) 
pid_y = (GAIN_P, GAIN_I, GAIN_D, I_MAX) 
pid_z = (GAIN_P, GAIN_I, GAIN_D, I_MAX) 
pid_r = (GAIN_P, GAIN_I, GAIN_D, I_MAX) 
while True:
    inputs = get_angles(cam, pid_x, pid_y, pid_z, pid_r)
    print("X:%f \rY:%f \r Z:%f \rR:%f\r\r,inputs(0),inputs(1),inputs(2),inputs(3)")
